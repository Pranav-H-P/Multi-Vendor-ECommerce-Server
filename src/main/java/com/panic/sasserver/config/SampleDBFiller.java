...
public class SampleDBFiller {
    ...
    public void fill(){//testing123 is the password for all accounts
        ...
        productDB.save(new Product(11L, "Hex Dumbbell 5kg", "Durable rubber-coated 5kg hex dumbbell", 750.0, 1L, 12, LocalDate.now()));
        productDB.save(new Product(11L, "Hex Dumbbell 7.5kg", "Durable rubber-coated 7.5kg hex dumbbell", 1125.0, 1L, 10, LocalDate.now()));
        productDB.save(new Product(11L, "Hex Dumbbell 10kg", "Durable rubber-coated 10kg hex dumbbell", 1500.0, 1L, 8, LocalDate.now()));
        productDB.save(new Product(11L, "Hex Dumbbell 15kg", "Durable rubber-coated 15kg hex dumbbell", 2250.0, 1L, 6, LocalDate.now()));
        productDB.save(new Product(12L, "Olympic Barbell 20kg", "High-quality 20kg Olympic barbell", 12000.0, 2L, 5, LocalDate.now()));
        productDB.save(new Product(12L, "Olympic Barbell 15kg", "High-quality 15kg Olympic barbell", 8000.0, 2L, 7, LocalDate.now()));
        productDB.save(new Product(12L, "EZ Curl Barbell 10kg", "Curved 10kg EZ curl barbell for arm exercises", 4500.0, 2L, 7, LocalDate.now()));
        productDB.save(new Product(13L, "Weight Plate 2.5kg", "Rubber-coated 2.5kg weight plate", 500.0, 3L, 25, LocalDate.now()));
        productDB.save(new Product(13L, "Weight Plate 5kg", "Rubber-coated 5kg weight plate", 1000.0, 3L, 20, LocalDate.now()));
        productDB.save(new Product(13L, "Weight Plate 10kg", "Rubber-coated 10kg weight plate", 2000.0, 3L, 15, LocalDate.now()));
        productDB.save(new Product(13L, "Weight Plate 20kg", "Rubber-coated 20kg weight plate", 4000.0, 3L, 10, LocalDate.now()));
        productDB.save(new Product(14L, "Weighted Vest 5kg", "Adjustable 5kg weighted vest", 2500.0, 4L, 8, LocalDate.now()));
        productDB.save(new Product(14L, "Weighted Vest 10kg", "Adjustable 10kg weighted vest", 3500.0, 4L, 6, LocalDate.now()));
        productDB.save(new Product(14L, "Weighted Vest 15kg", "Adjustable 15kg weighted vest", 4500.0, 4L, 4, LocalDate.now()));
        productDB.save(new Product(14L, "Weighted Ankle Cuffs 2kg", "Adjustable 2kg weighted ankle cuffs", 1200.0, 4L, 10, LocalDate.now()));
        productDB.save(new Product(13L, "Yoga Mat", "Eco-friendly non-slip yoga mat", 1000.0, 5L, 15, LocalDate.now()));
        productDB.save(new Product(13L, "Premium Yoga Mat", "Extra thick and durable yoga mat", 1500.0, 5L, 10, LocalDate.now()));
        productDB.save(new Product(12L, "Travel Yoga Mat", "Lightweight and compact yoga mat", 800.0, 5L, 12, LocalDate.now()));
        productDB.save(new Product(12L, "Lifting Belt Medium", "Leather lifting belt for medium builds", 1800.0, 6L, 10, LocalDate.now()));
        productDB.save(new Product(12L, "Lifting Belt Large", "Leather lifting belt for large builds", 2000.0, 6L, 8, LocalDate.now()));
        productDB.save(new Product(14L, "Grip Straps", "Heavy-duty lifting straps for grip support", 700.0, 7L, 20, LocalDate.now()));
        productDB.save(new Product(14L, "Lifting Gloves", "Padded gloves for extra grip and comfort", 1200.0, 7L, 15, LocalDate.now()));
        productDB.save(new Product(11L, "Power Rack", "Heavy-duty power rack for advanced lifters", 45000.0, 8L, 3, LocalDate.now()));
        productDB.save(new Product(12L, "Compact Power Rack", "Compact and affordable power rack", 35000.0, 8L, 5, LocalDate.now()));
        productDB.save(new Product(15L, "Flat Bench", "Sturdy flat bench for bench presses", 12000.0, 9L, 6, LocalDate.now()));
        productDB.save(new Product(15L, "Incline Bench", "Adjustable incline bench", 15000.0, 9L, 4, LocalDate.now()));
        productDB.save(new Product(15L, "Adjustable Bench", "Flat and incline bench in one", 18000.0, 9L, 3, LocalDate.now()));
        productDB.save(new Product(15L, "Lat Pulldown Machine", "Multi-purpose lat pulldown machine", 65000.0, 10L, 2, LocalDate.now()));
        productDB.save(new Product(15L, "Leg Press Machine", "High-quality leg press machine", 85000.0, 10L, 2,  LocalDate.now()));
        productDB.save(new Product(15L, "Cable Crossover Machine", "Versatile cable crossover machine", 95000.0, 10L, 1, LocalDate.now()));
